...
* [config.json](/evidence_library/GuardDuty/us-east-1/[DETECTOR_ID]/config.json) provides information on the configuration of each detector.
...
## Testing Details
1. For each in-scope region, review the [config.json](/evidence_library/GuardDuty/us-east-1/DETECTOR_ID_config.json) file and confirm the following:
