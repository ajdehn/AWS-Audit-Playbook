...
| 6.2 | EC2 Firewall Review | ??? | [COMING SOON](/coming_soon) | Automated |
| 7.1 | GuardDuty Enabled | GuardDuty is enabled for in-scope regions. | [Link](/controls/GD_Enabled) | Automated |
| 7.1 | GuardDuty Alerts | ??? | [Link](/controls/GD_Enabled) | Manual |
| 8 | Vulnerability Scans | ??? | [Link](/controls/IAM_Key_Age) | Manual |
| 9.1 | S3 Encryption | ??? | [Link](/controls/S3_Encrypt) | Automated |
| 9.2 | RDS Encryption | ??? | [Link](/controls/RDS_Encrypt) | Automated |
| 10.1 | RDS Tags | ??? | [Link](/controls/RDS_Tags) | Automated |
| 10.2 | S3 Tags | ??? | [Link](/controls/S3_Tags) | Automated |
| 10.3 | EC2 Tags | ??? | [Link](/controls/EC2_Tags) | Automated |
| 10.4 | EBS Tags | ??? | [Link](/controls/EBS_Tags) | Automated |
