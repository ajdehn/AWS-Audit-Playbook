...
2. Saved the list of Web ACLs in the audit evidence folder. See [WAF/[region]/web_acls.json](/evidence_library/WAF/us-east-2/web_acls.json).
...
4. Saved the associated Application Load Balancer ARNs for each Web ACL. See [WAF/[region]/[web_acl_name]/resources_alb.json](/evidence_library/WAF/us-east-2/example-acl/resources_alb.json).
...
6. Saved the associated API Gateway ARNs for each Web ACL. See [WAF/[region]/[web_acl_name]/resources_apigw.json](/evidence_library/WAF/us-east-2/example-acl/resources_apigw.json).
