...
## Project Goals
1. Improve audit quality by documenting audit procedures and providing example audit evidence + reports.
2. Save time currently spent on manual evidence collection for **both** auditors and engineers.
...
- **[training.itauditguy.com](https://training.itauditguy.com/)**: Allows **anyone** to login to an AWS sandbox.
