...
## Project Goals
1. Improve audit quality by sharing test procedures, example evidence, audit reports.
...
- **[Training Portal](https://training.itauditguy.com/)**: Allows **anyone** to login to an AWS sandbox.
