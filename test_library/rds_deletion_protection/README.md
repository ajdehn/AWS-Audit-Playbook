...
2. For each in-scope region, saved the list of RDS instances: [rds/[region_name]/db_instances.json](/evidence_library/rds/us-east-1/db_instances.json) and DB clusers: [rds/[region_name]/db_instances.json](/evidence_library/rds/us-east-1/db_instances.json).
