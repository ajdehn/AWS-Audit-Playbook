...
| 4 | Cloud resources are configured to block public access. | Automated | [S3 Public](S3_Public_Access)<br>[RDS Public](RDS_Public_Access) |A.8.9|
| 5 | Production database backups are taken daily, and are retained for at least 14 days. | Automated | [RDS Backup Retention](RDS_Backup_Retention) |A.8.13|
...
| 6.2 | Management conducts a firewall review on at least a quarterly basis. | Automated | [EC2 Security Group Tags](EC2_Security_Group_Tags) |A.8.20|
...
| 9.1 | Cloud resources are configured to encrypt data in-transit. | Automated | [S3 Secure Transport](S3_Secure_Transport)|A.8.24|
| 9.2 | Cloud resources are encrypted at rest. | Automated | [RDS Encryption](RDS_Encryption)<br>[S3 Encryption](S3_Encryption) |A.8.9, A.8.24|
